...
export default function Marker() {
  ...
  const [couponsIsFetching, setCouponsIsFetching] = useState(false);
  ...
  async function handleOpenCamera() {
    try {
      ...
      console.log(error);
      Alert.alert("Câmera", "Não foi possível usar a camera");
    }
  }
  ...
  function handleUseCoupon(id: string) {
    ...
    Alert.alert(
        "Cupom","Não é possivel reutilizar um cupom resgatado. Deseja realemente resgatar o cupom?",
        [
